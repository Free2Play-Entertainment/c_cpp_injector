...
base.append("UE_PROJECT_NAME=" + projectname)
base.append(projectname.upper() + "_VTABLE=DLLEXPORT_VTABLE")
base.append(projectname.upper() + "_API=")

vscode = os.path.join(os.getcwd(), ".vscode/")

if not path.exists(vscode):
    exit()

cpp = os.path.join(vscode, "c_cpp_properties.json")

if not path.exists(cpp):
    exit()
...
try:
    ...
    data["configurations"][0].append(base)
